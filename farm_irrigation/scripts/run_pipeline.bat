...
REM 检查当前目录
if not exist "src\core\pipeline.py" (
    echo [错误] 未找到src\core\pipeline.py文件
...
echo.
python -m src.core.pipeline --input-dir ./data/gzp_farm --output-dir ./data/output
goto end
...
REM 构建命令
set "cmd=python -m src.core.pipeline --input-dir \"%input_dir%\" --output-dir \"%output_dir%\""
...
echo.
echo 更多信息请查看: python -m src.core.pipeline --help
echo.
pause
goto menu
